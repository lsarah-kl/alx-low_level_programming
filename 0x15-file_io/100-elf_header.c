 ...
 * @e_ident: A pointer to an array to the ELF magic numbers.
 *
 ...
 * @e_ident: A pointer to an array containing the class if the ELF
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
 ...
 * @e_ident: A pointer to array containing the data
 */
void print_data(unsigned char *e_ident)
{
	printf(" Data: ");
...
/**
 * print_entry - function that prints the entry point of ELF header.
...
/**
 * main - Displaying the info contained in the
